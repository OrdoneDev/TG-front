export default function ArquivoColecao(infoArquivo) {
    let rateUp = []
    let rateDown = []
        ...
        <>
            <div class="flex flex-row py-0.5 justify-between">
                <div className="flex">
                    ...
                    <a href="#" className="hover:underline text-black hover:text-bold mt-0.5 bg-gray-200 rounded-full px-1.5 ml-1">{infoArquivo.descricao}.{infoArquivo.formato}</a>
