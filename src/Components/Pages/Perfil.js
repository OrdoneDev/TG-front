            ...
            <div class="w-full xl:w-[40%] lx:w-[45%] lg:w-[50%] ll:w-[60%] md:w-[75%] sm:w-[90%] w-[100%] mx-auto">
                ...
                <div class="w-full flex flex-col gap-1 pt-3 py-2 shadow-lg bg-white dark:bg-gray-600 px-5 dark:text-white">
                    <div class="flex items-center gap-1">
                        ...
                        <div className="flex content-end justify-end w-full mt-10  dark:text-green-400 hover:text-yellow-300">
                            ...
                            <button href="#" className="px-1.5 text-xs font-semibold text-white shadown-md hover:text-black rounded-full bg-blue-600">
                                Adicionar como amigo
                            </button>
                        </div>
                    </div>

                    <div class="mt-0.5 mb-2 leading-normal text-sm sm:text-base text-justify">
                        {usuario.biografia}
