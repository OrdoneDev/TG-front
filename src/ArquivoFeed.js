            ...
            <div class="flex flex-col">
                <div class="flex flex-col w-full leading-1.5 border-gray-200 ">
                    <div class="flex items-start bg-gray-100 rounded-xl p-2 shadow">
                        ...
                        <button class="inline-flex self-center items-center p-2 text-sm font-medium text-center text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-50 dark:bg-gray-300 dark:hover:bg-gray-500 dark:focus:ring-gray-600" type="button">
