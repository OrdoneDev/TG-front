  ...
  return (
    <div className="flex min-h-full flex-1 flex-col justify-center px-10 py-5 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <button class="mt-10 w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 flex items-center bg-white border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
