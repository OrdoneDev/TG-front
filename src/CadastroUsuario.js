    ...
    return (
        <div className="flex min-h-full flex-col items-center justify-center px-5 py-11 lg:px-8">
            <div class="max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-4">
                ...
                <div>
                    <button class="mt-5 w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 flex items-center bg-white border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                    <svg class="h-7 w-6 mr-2" viewBox="-0.5 0 48 48" version="1.1">
            ...
            <div class="max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-4">
                ...
                <form class="mt-10 max-w-md mx-auto">
                    ...
                    <div class="relative z-0 w-full mb-5 group">
                        ...
                        <label for="floating_email" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">E-mail</label>
                    </div>
                    <div class="relative z-0 w-full mb-5 group">
                    ...
                    <div class="flex items-start mb-5">
                        <div class="flex items-center h-5">
                            ...
                            <label for="terms" class="ms-2 text-sm text-black">I agree with the <a href="#" class="text-blue-600 hover:underline dark:text-blue-500">terms and conditions</a></label>
                    </div>
